...
#define handle_case_25	18+7 //18
#define handle_case_26	27+7 //27
...
#define handle_case_35	-(24+7) //24
#define handle_case_36	-(29+7) //29
...
ISR(TIMER0_COMP_vect)
{
	...
	if(pulse_time_get_sample==time_get_sample) {
		uint8_t temp_straight=pulse_v_des;
		uint8_t temp_crook=pulse_v_crook_des;
		vloc=pulse_v;
		PID_ctrl_motor();
		pulse_v=0; //reset
		pulse_time_get_sample=0;
